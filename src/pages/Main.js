    ...
    return (
        <>
            <MapView
                ...
                style={styles.map}
            >
                {/* Using () = the return of the function
                Using {} = the content of the function */}
                {devs.map(dev => (
                    <Marker
                        key={dev._id}
                        coordinate={{
